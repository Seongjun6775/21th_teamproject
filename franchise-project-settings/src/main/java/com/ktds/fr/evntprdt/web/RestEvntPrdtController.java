...
public class RestEvntPrdtController {
   ...
   //이벤트 상품 등록
	  ...
	  @PostMapping("/api/evntPrdt/create") public ApiResponseVO
	  createNewEvntPrdt(EvntPrdtVO evntPrdtVO) throws Exception {
	  
	  //실행여부 확인 System.out.println("/api/evntPrdt/create 호출 확인!!!");
	  System.out.println("evntVO.getEvntId() : " + evntPrdtVO.getPrdtId());
	  System.out.println("evntVO.getEvntTtl() : " + evntPrdtVO.getPrdtNm());
	  System.out.println("evntVO.getEvntCntnt() : " + evntPrdtVO.getPrdtPrc());

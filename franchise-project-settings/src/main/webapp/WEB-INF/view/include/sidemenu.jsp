      ...
      <li class="mb-1">
        ...
        <div class="collapse " id="home-collapse">
          <ul class="text-light btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li class="rounded"><a href="${context}/mbr/list" class="text-light link-body-emphasis d-inline-flex text-decoration-none rounded">회원목록 조회</a></li>
            <li class="rounded"><a href="${context}/mbr/admin/list" class="text-light link-body-emphasis d-inline-flex text-decoration-none rounded">권한/소속 변경</a></li>

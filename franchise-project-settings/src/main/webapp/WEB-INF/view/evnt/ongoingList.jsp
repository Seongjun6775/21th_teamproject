									...
									<div class="img-box" style="width: 600px; height: 600px;">
										<c:choose>
											<c:when test="${empty evnt.uuidFlNm}">
												<img src="${context}/img/default_photo.jpg" style="width:400px; height:400px; float:right;" >
											</c:when>
											<c:otherwise>
												<a href="${context}/evnt/detail_customer/${evnt.evntId}"> 
												<img src="${context}/evnt/img/${evnt.uuidFlNm}/" style="width:400px; height:400px; float:right;" ></a>
											</c:otherwise>
										</c:choose>
									</div>
									<div class="prdt3">
